...
<p class="lead">
	...
	<?php 
		...
		echo $this->Form->hidden( 'ItemPedido.produto_id');
		...
		echo $this->Form->input( 'ItemPedido.unitario_total', array('disabled'=>true, 'label' => 'Valor Unitário', 'class' => 'span2','type'=>'text','placeholder'=>'0,00','div'=>array('class'=>'pull-left') ) );
		...
		if($preco_cliente > 0){
				echo $this->Form->input( 'ItemPedido.valor_unitario', array('disabled'=>true, 'value'=>$preco_cliente, 'label' => 'Valor Unitário', 'class' => 'span2','type'=>'text','placeholder'=>'0,00','required'=>true,'div'=>array('class'=>'pull-left')) );
			}else{
				echo $this->Form->input( 'ItemPedido.valor_unitario', array('disabled'=>true, 'value'=>$preco, 'label' => 'Valor Unitário', 'class' => 'span2','type'=>'text','placeholder'=>'0,00','required'=>true,'div'=>array('class'=>'pull-left')) );
			}	
		
		//	echo $this->Form->input( 'ItemPedido.valor_unitario', array('disabled'=>true, 'value'=>$preco, 'label' => 'Valor Unitário', 'class' => 'span2','type'=>'text','placeholder'=>'0,00','required'=>true,'div'=>array('class'=>'pull-left')) );

		// if($_SERVER['REMOTE_ADDR'] == '168.227.12.216'){
		...
		echo $this->Form->hidden( 'ItemPedido.pago', array('value'=>$total));
		echo $this->Form->hidden( 'ItemPedido.valor_total_tmp');
		echo $this->Form->hidden( 'ItemPedido.valor_unitario_tmp', array('value'=>$preco));
		
		echo $this->Form->input( 'ItemPedido.pago_display', array( 'disabled'=>true, 'value'=>$total, 'label' => 'Valor Pago', 'class' => 'span2','type'=>'text','placeholder'=>'0,00','required'=>true ) );
